  ...
  return (
    <div className="landing">
      <section className="hero">
        ...
        <p>Modern. Fair. On-Chain. Fast 1v1 poker on Core Blockchain with CorePass auth and live leaderboards.</p>
      ...
      <section id="tokenomics" className="how">
        ...
        <div style={{ marginTop: 10 }}>
          ...
          <svg viewBox="0 0 100 12" width="100%" height="32" preserveAspectRatio="none" aria-label="Daily split bar">
            <rect x="0" y="0" width="75" height="12" fill="#8b5cf6" />
          ...
          <div style={{ display:'flex', flexWrap:'wrap', gap:8, marginTop:6, fontSize:12 }}>
            <span><span style={{ display:'inline-block', width:10, height:10, background:'#8b5cf6', borderRadius:2, marginRight:4 }} />75% Players</span>
      ...
      <section className="features">
        ...
        <div className="feat"><h3>CorePass Login</h3><p>Scan a QR code or tap the deep-link on mobile - no passwords, no seed phrases.</p></div>
        <div className="feat"><h3>Leaderboards</h3><p>Wins and hands tracked live - compete with the community.</p></div>
      </section>
      <section id="how" className="how">
        <h2>Get started</h2>
        <ol>
          <li>Log in with CorePass - scan the QR or tap the deep-link.</li>
