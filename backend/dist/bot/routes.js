...
import { registerBot, getBot, getBotByName, listBots, deleteBot, getLeaderboard, requireBotAuth, generateApiKey, listKeysForBot, revokeApiKey, getConnectedBotCount, getConnectedBotIds, isBotConnected, } from './index.js';
import { joinQueue, leaveQueue, getQueueStatus, getQueuePosition, getActiveMatches, getBotMatch, isInMatch, } from './matchmaking.js';
 ...
 */
botRouter.post('/queue/join', requireBotAuth, (req, res) => {
    try {
 ...
 */
botRouter.post('/queue/leave', requireBotAuth, (req, res) => {
    try {
        const botId = req.botId;
        leaveQueue(botId);
        res.json({ ok: true });
 ...
 */
botRouter.get('/queue/status', (req, res) => {
    try {
 ...
 */
botRouter.get('/match', requireBotAuth, (req, res) => {
    try {
        const botId = req.botId;
